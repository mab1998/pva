...
class InvoiceController2 extends Controller
{
    ...
    public function allInvoices()
    {
        ...
        return view('admin1.all-invoices', compact('invoices'));
    }
    ...
    public function addInvoice()
    {
        ...
        return view('admin1.add-new-invoice', compact('clients'));
    }
    ...
    public function postInvoice(Request $request)
    {
        ...
        if ($v->fails()) {
            return redirect('invoices/add1')->withInput($request->all())->withErrors($v->errors());
        }
        ...
        if ($cid == '') {
            return redirect('invoices/add1')->withInput($request->all())->with(array('message' => language_data('Select a Customer'), 'message_important' => true));
        }
        if ($idate == '') {
            return redirect('invoices/add1')->withInput($request->all())->with(array('message' => language_data('Invoice Created date is required'), 'message_important' => true));
        }
        if ($pdate == '') {
            return redirect('invoices/add1')->withInput($request->all())->with(array('message' => language_data('Invoice Paid date is required'), 'message_important' => true));
        }
        if ($amount == '') {
            return redirect('invoices/add1')->withInput($request->all())->with(array('message' => language_data('At least one item is required'), 'message_important' => true));
        }

        if (isset($description) && !is_array($description) || count(array_filter($description)) <= 0) {
            return redirect('invoices/add1')->withInput($request->all())->with(array(
        ...
        if ($invoice_type == 'recurring') {
            ...
            $repeat = $request->get('repeat_type');
            $its    = strtotime($idate);
            ...
            if ($repeat == 'week1') {
                ...
                return redirect('invoices/add1')->withInput($request->all())->with(array('message' => language_data('Date Parsing Error'), 'message_important' => true));
            }
            $ddate        = $nd;
            $bill_created = 'no';
        } else {
        ...
        if ($ddate == '') {
            return redirect('invoices/add1')->withInput($request->all())->with(array('message' => language_data('Invoice Due date is required'), 'message_important' => true));
        }
        ...
        return redirect('invoices/view1/' . $inv_id)->with(['message' => language_data('Invoice Created Successfully')]);
    }
    ...
    public function viewInvoice($id)
    {
        ...
        if ($inv) {
            ...
            return view('admin1.view-invoice', compact('client', 'inv', 'inv_items', 'tax_sum', 'dis_sum'));
        } else {
    ...
    public function editInvoice($id)
    {
        ...
        if ($inv) {
            $client    = Client::where('status', 'Active')->find($inv->cl_id);
            $inv_items = InvoiceItems::where('inv_id', $id)->get();
            return view('admin1.edit-invoice', compact('client', 'inv', 'inv_items'));
        } else {
            return redirect('invoices/all1')->with([
                'message' => language_data('Invoice not found'),
                'message_important' => true
    ...
    public function postEditInvoice(Request $request)
    {
        ...
        if ($appStage == 'Demo') {
            return redirect('invoices/edit1/' . $id)->with([
        ...
        if ($v->fails()) {
            return redirect('invoices/edit1/' . $id)->withErrors($v->errors());
        }
        $cid          = $request->get('client_id');
        $notes        = $request->get('notes');
        $amount       = $request->get('amount');
        ...
        if ($cid == '') {
            return redirect('invoices/edit1/' . $id)->with(array('message' => language_data('Select a Customer'), 'message_important' => true));
        }
        if ($idate == '') {
            return redirect('invoices/edit1/' . $id)->with(array('message' => language_data('Invoice Created date is required'), 'message_important' => true));
        }

        if ($pdate == '') {
            return redirect('invoices/edit1/' . $id)->with(array('message' => language_data('Invoice Paid date is required'), 'message_important' => true));
        }
        if ($amount == '') {
            return redirect('invoices/edit1/' . $id)->with(array('message' => language_data('At least one item is required'), 'message_important' => true));
        }


        if (!is_array($description) || count(array_filter($description)) <= 0) {
            return redirect('invoices/edit1/' . $id)->withInput($request->all())->with(array(
                'message' => language_data('At least one item is required'),
                'message_important' => true
            ));
        }
        ...
        if ($invoice_type == 'recurring') {
            ...
            if ($repeat == 'week1') {
                ...
                return redirect('invoices/add1')->with(array('message' => language_data('Date Parsing Error'), 'message_important' => true));
            }
            $ddate = $nd;
        } else {
            $r = '0';
        ...
        if ($ddate == '') {
            return redirect('invoices/edit1/' . $id)->with(array('message' => language_data('Invoice Due date is required'), 'message_important' => true));
        }
    ...
    public function clientIView($id)
    {
        ...
        if ($inv) {
            ...
            $tax_sum   = InvoiceItems::where('inv_id', $id)->sum('tax');
            $dis_sum   = InvoiceItems::where('inv_id', $id)->sum('discount');
            return view('admin1.invoice-client-view', compact('client', 'inv', 'inv_items', 'tax_sum', 'dis_sum'));
        } else {
            return redirect('invoices/all1')->with([
                'message' => language_data('Invoice not found'),
                'message_important' => true
    ...
    public function printView($id)
    {
        ...
        if ($inv) {
            ...
            $tax_sum   = InvoiceItems::where('inv_id', $id)->sum('tax');
            $dis_sum   = InvoiceItems::where('inv_id', $id)->sum('discount');
            return view('admin1.invoice-print-view', compact('client', 'inv', 'inv_items', 'tax_sum', 'dis_sum'));
        } else {
            return redirect('invoices/all1')->with([
                'message' => language_data('Invoice not found'),
                'message_important' => true
