...
class SMSController2 extends Controller
{
    ...
    public function pricePlan()
    {
        ...
        return view('admin1.sms-price-plan', compact('price_plans'));
    }
    ...
    public function addPricePlan()
    {
        ...
        return view('admin1.add-price-plan');
    }
    ...
    public function postNewPricePlan(Request $request)
    {
        ...
        if ($v->fails()) {
            return redirect('sms/add-price-plan1')->withErrors($v->errors());
        }

        $exist_plan = SMSPricePlan::where('plan_name', $request->plan_name)->first();
        if ($exist_plan) {
            return redirect('sms/add-price-plan1')->with([
        ...
        return redirect('sms/price-plan1')->with([
    ...
    public function managePricePlan($id)
    {
        ...
        if ($price_plan) {
            return view('admin1.manage-price-plan1', compact('price_plan'));
        } else {
            return redirect('sms/price-plan1')->with([
    ...
    public function postManagePricePlan(Request $request)
    {
        ...
        if ($v->fails()) {
            return redirect('sms/manage-price-plan1/' . $cmd)->withInput($request->all())->withErrors($v->errors());
        }
        ...
        if ($plan) {
            if ($plan->plan_name != $request->plan_name) {
                $exist_plan = SMSPricePlan::where('plan_name', $request->plan_name)->first();
                if ($exist_plan) {
                    return redirect('sms/manage-price-plan1/' . $cmd)->withInput($request->all())->with([
                        'message' => language_data('Plan already exist'),
                        'message_important' => true
                    ]);
                }
    ...
    public function addPlanFeature($id)
    {
        ...
        $price_plan = SMSPricePlan::find($id);
        if ($price_plan) {
            return view('admin1.add-plan-feature', compact('price_plan'));
        } else {
            return redirect('sms/price-plan1')->with([
                'message' => language_data('Plan not found'),
                'message_important' => true
    ...
    public function postNewPlanFeature(Request $request)
    {
        ...
        if ($v->fails()) {
            return redirect('sms/add-plan-feature1/' . $cmd)->withInput($request->all())->withErrors($v->errors());
        }
    ...
    public function deletePlanFeature($id)
    {
        ...
        if ($plan_feature) {
            ...
            $plan_feature->delete();
            return redirect('sms/view-plan-feature1/' . $pid)->with([
