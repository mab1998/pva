...
class UserTicketController2 extends Controller
{
    ...
    public function allSupportTickets()
    {
        ...
        return view('client1.support-tickets', compact('st'));
    }
    ...
    public function createNewTicket()
    {
        ...
        return view('client1.create-new-ticket', compact('sd'));
    }
    ...
    public function postTicket(Request $request)
    {
        ...
        if ($v->fails()) {
            return redirect('user/tickets/create-new1')->withErrors($v->errors());
        }
    ...
    public function viewTicket($id)
    {
        ...
        return view('client1.view-support-ticket', compact('st',  'td', 'trply', 'department', 'ticket_file'));
    }
    ...
    public function replayTicket(Request $request)
    {
        ...
        if ($v->fails()) {
            return redirect('user/tickets/view-ticket1/' . $cmd)->withErrors($v->errors());
        }
    ...
    public function postTicketFiles(Request $request)
    {
        ...
        if ($file != '' && app_config('AppStage') != 'Demo') {
            ...
            if (isset($file) && in_array(strtolower($file->getClientOriginalExtension()), array("png", "jpeg", "gif", 'jpg'))) {
                $destinationPath = public_path() . '/assets1/ticket_file/';
