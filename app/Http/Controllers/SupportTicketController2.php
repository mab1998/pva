...
class SupportTicketController2 extends Controller
{
    ...
    public function all()
    {
        ...
        return view('admin1.support-tickets', compact('st'));
    }
    ...
    public function department()
    {
        ...
        return view('admin1.support-department', compact('sd'));
    }
    ...
    public function postDepartment(Request $request)
    {
        ...
        if ($v->fails()) {
            return redirect('support-tickets/add-department1')->withErrors($v->errors());
        }
        ...
        if ($dname != '') {
            ...
            if ($d) {
                return redirect('support-tickets/add-department1')->with([
        ...
        return redirect('support-tickets/department1')->with([
    ...
    public function viewDepartment($id)
    {
        ...
        return view('admin1.view-department', compact('d'));
    }
    ...
    public function updateDepartment(Request $request)
    {
        ...
        if ($appStage == 'Demo') {
            return redirect('support-tickets/view-department1/' . $id)->with([
        ...
        if ($v->fails()) {
            return redirect('support-tickets/view-department1/' . $id)->withErrors($v->errors());
        }
    ...
    public function createNew()
    {
        ...
        return view('admin1.create-new-ticket', compact('sd', 'cl'));
    }
    ...
    public function postTicket(Request $request)
    {
        ...
        if ($v->fails()) {
            return redirect('support-tickets/create-new1')->withInput($request->all())->withErrors($v->errors());
        }
    ...
    public function viewTicket($id)
    {
        ...
        return view('admin1.view-support-ticket', compact('st', 'td', 'trply', 'department', 'ticket_file'));
    }
    ...
    public function postBasicInfo(Request $request)
    {
        ...
        if ($v->fails()) {
            return redirect('support-tickets/view-ticket1/' . $cmd)->withErrors($v->errors());
        }
    ...
    public function postTicketFiles(Request $request)
    {
        ...
        if ($file != '' && app_config('AppStage') != 'Demo') {
            ...
            if (isset($file) && in_array(strtolower($file->getClientOriginalExtension()), array("png", "jpeg", "gif", 'jpg'))) {
                $destinationPath = public_path() . '/assets/ticket_file1/';
    ...
    public function downloadTicketFile($id)
    {
        ...
        return response()->download(public_path('assets1/ticket_file/' . $ticket_file));
    }
    ...
    public function deleteTicketFile($id)
    {
        ...
        if ($ticket_file) {
            ...
            \File::delete(public_path('assets/ticket_file1/' . $file));
            $ticket_file->delete();

            return redirect('support-tickets/view-ticket1/' . $ticket_id)->with([
                'message' => language_data('File Deleted Successfully')
            ]);
        } else {
            return redirect('support-tickets/all1')->with([
