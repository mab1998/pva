                ...
                <div class="col-lg-12">
                    <div class="tab-content panel p-20">
                        <div role="tabpanel" class="tab-pane active" id="edit-profile">
                            <form role="form" action="{{url('clients/update-client-post1')}}" method="post">
                                {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-md-4">
    ...
    <div class="modal fade modal_send_sms_{{$client->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="form-some-up form-block" role="form" action="{{url('clients/send-sms1')}}" method="post">
    ...
    <div class="modal fade modal_update_limit_{{$client->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="form-some-up form-block" role="form" action="{{url('clients/update-limit1')}}" method="post">
    ...
    <div class="modal fade modal_change_image_{{$client->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="form-some-up form-block" role="form" action="{{url('clients/update-image1')}}" method="post" enctype="multipart/form-data">
