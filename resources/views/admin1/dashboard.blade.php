                            ...
                            <div class="z-shad-1">
                                <div class="bg-success text-white p-15 clearfix">
                                    ...
                                    <div class="pull-right text-right m-t-15">
                                        ...
                                        <br>
                                        <a href="{{url('clients/add1')}}" class="btn btn-complete btn-xs text-uppercase">{{language_data('Add New')}}</a>
                                    </div>
                            ...
                            <div class="z-shad-1">
                                <div class="bg-danger text-white p-15 clearfix">
                                    ...
                                    <div class="pull-right text-right m-t-15">
                                        ...
                                        <br>
                                        <a href="{{url('support-tickets/create-new1')}}" class="btn btn-complete btn-xs text-uppercase">{{language_data('Add New')}}</a>
                                    </div>
