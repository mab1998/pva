                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-6 col-md-3 col-sm-3 col-xs-12">
                                <div class="btn-group pull-right" aria-label="...">
                                    ...
                                    <a href="{{url('invoices/client-iview1/'.$inv->id)}}" target="_blank" class="btn btn-danger  btn-sm"><i class="fa fa-paper-plane-o"></i> {{language_data('Preview')}}</a>
                                    <a href="{{url('invoices/edit1/'.$inv->id)}}" class="btn btn-warning  btn-sm"><i
                                    ...
                                    <a href="{{url('invoices/download-pdf1/'.$inv->id)}}"
                                       class="btn btn-pdf  btn-sm download-pdf"><i
                                                class="fa fa-file-pdf-o"></i> {{language_data('PDF')}}</a>
                                    <a href="{{url('invoices/iprint1/'.$inv->id)}}" target="_blank"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form class="form-some-up" role="form"
                                                          action="{{url('invoices/send-invoice-email1')}}"
                                                          method="post">
      ...
      $(document).ready(function () {
        ...
        $('#mark_paid').click(function (e) {
          ...
          var id = $(this).data('value')
            ...
            if (result) {
              var _url = $('#_url').val()
              window.location.href = _url + '/invoices/mark-paid1/' + id
            }
          })
        })
        ...
        $('#mark_unpaid').click(function (e) {
          ...
          var id = $(this).data('value')
            ...
            if (result) {
              var _url = $('#_url').val()
              window.location.href = _url + '/invoices/mark-unpaid1/' + id
            }
          })
        })
        ...
        $('#mark_partially_paid').click(function (e) {
          ...
          var id = $(this).data('value')
            ...
            if (result) {
              var _url = $('#_url').val()
              window.location.href = _url + '/invoices/mark-partially-paid1/' + id
            }
          })
        })
        ...
        $('#mark_cancelled').click(function (e) {
          ...
          var id = $(this).data('value')
            ...
            if (result) {
              var _url = $('#_url').val()
              window.location.href = _url + '/invoices/mark-cancelled1/' + id
            }
          })
        })
