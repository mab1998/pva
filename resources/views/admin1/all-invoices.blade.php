                            ...
                            <table class="table data-table table-hover">
                                ...
                                @foreach($invoices as $in)
                                    <tr>
                                        ...
                                        <td><a href="{{url('clients/view1/'.$in->cl_id)}}">{{$in->client_name}}</a></td>
                                        ...
                                        <td>
                                            ...
                                            @endif
                                            <a href="{{url('invoices/view1/'.$in->id)}}" class="btn btn-success btn-xs"><i class="fa fa-eye"></i> {{language_data('View')}}</a>
                                            <a href="{{url('invoices/edit1/'.$in->id)}}" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> {{language_data('Edit')}}</a>
