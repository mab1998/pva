                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="tab-content p-20">
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="ticket_discussion">
                                            <form method="POST" action="{{ url('user/tickets/replay-ticket1') }}">
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="ticket_files">
                                            <form role="form" method="post" action="{{url('user/tickets/post-ticket-files1')}}" enctype="multipart/form-data">
                                                ...
                                                @foreach($ticket_file as $tf)
                                                    <tr>
                                                        ...
                                                        <td data-label="{{language_data('Action',Auth::guard('client')->user()->lan_id)}}" class="text-right">
                                                            <a href="{{url('user/tickets/download-file1/'.$tf->id)}}" class="btn btn-success btn-xs"><i class="fa fa-download"></i> </a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
