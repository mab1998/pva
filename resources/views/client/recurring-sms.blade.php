...
@section('content')
    ...
    <section class="wrapper-bottom-sec">
        <div class="p-30">
            <h2 class="page-title">{{language_data('Recurring SMS',Auth::guard('client')->user()->lan_id)}}</h2>
        </div>
                ...
                <div class="col-sm-12">
                    <div class="panel">
                        <div class="panel-heading">
                            {{language_data('Recurring Note',Auth::guard('client')->user()->lan_id)}}:
                        </div>
                        <div class="panel-body">
                            {{language_data('The sms unit will be deducted when the recurring sms task starts. If you do not have enough sms unit then
                            its automatically stop the recurring process and sms not send to users',Auth::guard('client')->user()->lan_id)}}.
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            <h3 class="panel-title">{{language_data('Recurring SMS',Auth::guard('client')->user()->lan_id)}}</h3>
                        </div>
                        <div class="panel-body">
