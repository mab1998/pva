...
@section('content')
    ...
    <section class="wrapper-bottom-sec">
        <div class="p-30">
            <h2 class="page-title">{{language_data('View Contacts')}}</h2>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            <h3 class="panel-title">{{language_data('View Contacts')}}</h3>
                        </div>
                        <div class="panel-body p-none">
                            <table class="table data-table table-hover">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 15%;">{{language_data('User name')}}</th>
    ...
    <script>
        $(document).ready(function(){
            ...
            var oTable = $('.data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{!! url('sms/get-all-contact/'.$id) !!}',
                columns: [
            ...
            deleteTriger.on("click", function(event){ // triggering delete one by one
                if( $('.deleteRow:checked').length > 0 ){  // at-least one checkbox checked
                    ...
                    $.ajax({
                        type: "POST",
                        url: '{!! url('/sms/delete-bulk-contact/') !!}',
            ...
            $( "body" ).delegate( ".cdelete", "click",function (e) {
              ...
              bootbox.confirm("{!! language_data('Are you sure') !!}?", function (result) {
                    if (result) {
                        var _url = $("#_url").val();
                        window.location.href = _url + "/sms/delete-contact/" + id;
                    }
                });
            });
