<div class="modal fade modal_edit_administrator_roles_{{$er->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">

    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">{{language_data('Edit Administrator Role')}}</h4>
            </div>
            <form class="form-some-up form-block" role="form" action="{{url('administrators/update-role')}}" method="post">
